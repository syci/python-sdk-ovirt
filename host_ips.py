                    ...
                    if bonded:
                        ...
                        if slvs_nics_list:
                            for sl in slvs_nics_list:
                                print (
                                'Details:BootProto:%s\t get_bridged:%s \t get_mac:%s \t get_check_connectivity:%s get_sttaus:%s' % (
                                sl.get_boot_protocol(), sl.get_bridged(), sl.get_mac(), sl.get_check_connectivity(),
                                sl.get_status()))
                                print sl.get_name()
